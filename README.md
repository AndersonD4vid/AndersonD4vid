[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=91a8ff&size=35&center=true&vCenter=true&width=1000&lines=Olá,+meu+nome+é+Anderson;Tenho+22+anos;Sou+do+Brasil;Seja+muito+bem-vindo(a)+:%29)](https://git.io/typing-svg)
...
# Sobre mim
Olá, meu nome é Anderson, também sou UX/UI designer e tenho 23 anos.

Já atuei em projetos como o Sistema de Reservas de Viagens com integração de pagamento utilizando a Stripe. Meu primeiro contato com a tecnologia foi em 2016, quando eu jogava Minecraft. Foi lá que comecei a estudar Java e a criar meus primeiros plugins em Java junto com um amigo para nosso servidor. Não gostava muito de Java, então logo pensei: vou deixar essa parte de desenvolvimento de plugins para meu amigo e começar a criar o site para vender os VIPS no servidor. Ainda em 2016, comecei a estudar HTML, CSS e o básico de JavaScript. Pegava aqueles botões de pagamento do PayPal que a gente criava no painel e os colocava no site como se fosse uma loja integrada, haha. Foi aí que percebi o quão incrível a tecnologia podia ser. Também comecei a estudar constantemente inglês, pois a maioria das documentações estava em inglês. Então, estudava pelo menos 10 minutos por dia. Isso foi muito útil para ler em inglês, mas acabou atrapalhando um pouco também, pois aprendi a ler mais do que falar (risos). No entanto, com o tempo, fui aprendendo a falar aos poucos e hoje me sinto um pouco mais confortável em me expressar em algumas ocasiões.

De 2016 até 2018, criei vários projetos básicos com JavaScript. Acabei perdendo todos os projetos quando formatei o PC, pois não conhecia o GitHub. Meu PC acabou queimando e eu estava sem condições de comprar outro, pois estava desempregado. Em 2019, comecei a trabalhar como garçom, juntei um dinheiro e comprei um notebook gamer. Investi em um curso de React.js da Udemy e comecei a estudar. Desde então, venho estudando constantemente e me aprimorando cada vez mais. Bom, essa é minha história.

Agradeço a todos que leram até aqui. Espero poder ajudar outras pessoas com o meu conhecimento e também espero aprender com vocês.
